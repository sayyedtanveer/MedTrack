    ...
    theme: {
        ...
        extend: {
            colors: {
                ...
                primary: __assign({ DEFAULT: "hsl(var(--primary))", foreground: "hsl(var(--primary-foreground))" }, tokenColors.primary),
                secondary: {
            ...
            fontFamily: {
                sans: __spreadArray([], typography.fontFamily.sans, true),
                mono: __spreadArray([], typography.fontFamily.mono, true),
            },
            fontSize: __assign({}, typography.fontSize),
            fontWeight: __assign({}, typography.fontWeight),
            lineHeight: __assign({}, typography.lineHeight),
            letterSpacing: __assign({}, typography.letterSpacing),
            spacing: __assign({}, tokenSpacing),
            boxShadow: __assign({}, shadows),
            keyframes: {
                "accordion-down": {
                    from: { height: "0" },
